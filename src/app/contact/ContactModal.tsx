...
const ContactModal: React.FC<ContactModalProps> = ({
  ...
  return createPortal(
    <div
      className='absolute h-100 w-90 rounded-xl bg-second-dark border border-white flex flex-col items-center p-8 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10'
      ref={modalRef}
    >
      <button className='flex w-full justify-end items-start mb-4 text-white'>
        <CloseIcon
